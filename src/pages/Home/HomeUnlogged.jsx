    ...
    <div className="h-full">
      <div className="flex justify-center items-center h-dvh">
        <div className=" max-w-2xl text-dark-background dark:text-light-secondary text-center">
          ...
          <button className="my-8 mb-20 p-4 text-xl rounded-lg min-w-80 bg-light-accent text-light-background dark:bg-light-accent dark:text-dark-background  hover:bg-light-highlight dark:hover:bg-dark-highlight"> Comece agora! </button>
      ...
      <div className="py-12 mx-20 mt-10 text-dark-background dark:text-light-secondary">
        ...
        <div className="mt-6 mx-auto space-y-6">
          <blockquote className="inline-block max-w-xs h-44 p-4 mr-5 align-bottom border-light-primary border-4 rounded-lg">
